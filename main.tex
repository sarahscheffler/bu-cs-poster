...
\title{Lorem Ipsum} % Poster title

\author{Person A, Person B, Person C} % Author(s)

\institute{\{persona, personb, personc\}@bu.edu} % Institution(s) or emails
...
\begin{scope}[transform canvas={xshift=-3cm, yshift=-14.5cm}]
